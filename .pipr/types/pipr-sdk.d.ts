...
type CommentSource = CommentValue | (() => CommentValue | Promise<CommentValue>);
type CommentOptions = {
  key?: string;
  order?: number;
  paths?: PathFilter;
